...
label_roots.pack()
frame_all=Frame(root,width=1200,height=1000,bg="#f2f2f2")
...
def frame_user():
    ...
    def edit():
        ...
        try:
            ...
            messagebox.showerror("An error occured",err)
...
label_options=Label(options_frame,text="Dashboard",font=("Arial",26,"bold"),fg="black",bg="#FFFACD")
label_options.place(x=24,y=26)
